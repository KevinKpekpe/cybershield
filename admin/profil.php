        ...
        try {
            ...
            echo '<script>
                document.addEventListener("DOMContentLoaded", function() {
                    createAlert("success", "Succès", "Profil mis à jour avec succès ! Redirection...");
                });
            </script>';
        ...
        if (password_verify($current_password, $user['password'])) {
            ...
            if (!preg_match($regex, $new_password)) {
                ...
                try {
                    ...
                    echo '<script>
                        document.addEventListener("DOMContentLoaded", function() {
                            createAlert("success", "Succès", "Mot de passe mis à jour avec succès ! Redirection...");
                        });
                    </script>';
                } catch (PDOException $e) {
...
<head>
    ...
    <!-- Vos liens CSS et scripts éventuels -->
</head>
<body>
            ...
            <div class="profile-sidebar">
                ...
                <div class="profile-status">
                    <div class="status-badge status-<?= $user['active'] ? 'active' : 'inactive' ?>">
                        <i class="fas fa-circle"></i> <?= $user['active'] ? 'Actif' : 'Inactif' ?>
                    </div>
                    <div class="status-role"><?= ucfirst($user['role']) ?></div>
                </div>
            </div>
